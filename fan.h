...
public:
	...
	Shader local_rotation(Shader ourShader, unsigned int VAOF3,  float angle = 0) {
		...
		model = transforamtion(2.125, 2.35, -5.625, rotateAngle_X, rotateAngle_Y, 45, .5, .05, 2);
		modelMatrices.push_back(model);
		model = transforamtion(2.375, 2.35, -5.875, rotateAngle_X, rotateAngle_Y, -45, -.5, .05, -2);
		modelMatrices.push_back(model);
		model = transforamtion(2.375, 2.35, -5.875, -45, rotateAngle_Y, rotateAngle_Z, 2, .05, .5);
		modelMatrices.push_back(model);
		model = transforamtion(2.125, 2.35, -5.625, 45, rotateAngle_Y, rotateAngle_Z, -2, .05, -.5);
		modelMatrices.push_back(model);
